...
part of 'StarshipsModel.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class StarshipsAdapter extends TypeAdapter<Starships> {
  @override
  final int typeId = 3;

  @override
  Starships read(BinaryReader reader) {
    ...
    return Starships(
      ...
      pilots: (fields[13] as List?)?.cast<String>(),
  ...
  @override
  void write(BinaryWriter writer, Starships obj) {
    writer
      ..writeByte(18)
      ..writeByte(0)
      ..write(obj.name)
