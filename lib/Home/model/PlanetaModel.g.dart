...
part of 'PlanetaModel.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class PlanetaAdapter extends TypeAdapter<Planeta> {
  @override
  final int typeId = 2;

  @override
  Planeta read(BinaryReader reader) {
    ...
    return Planeta(
      ...
      residents: (fields[9] as List?)?.cast<String>(),
  ...
  @override
  void write(BinaryWriter writer, Planeta obj) {
    writer
      ..writeByte(14)
      ..writeByte(0)
      ..write(obj.name)
